...
impl RoadWearGrid {
    ...
    pub fn wear_color(&self, x: usize, y: usize) -> u32 {
        ...
        if wear < DAMAGE_THRESHOLD {
            ...
            let alpha = ((wear - DAMAGE_THRESHOLD) / (SEVERE_DAMAGE_THRESHOLD - DAMAGE_THRESHOLD) * 0x88) as u32;
            (alpha << 24) | 0x00_FF_FF_00 // Amarillo
        } else {
            let alpha = ((wear - SEVERE_DAMAGE_THRESHOLD) / (MAX_WEAR - SEVERE_DAMAGE_THRESHOLD) * 0xAA) as u32;
