...
El equipo de Rycimmu conserva el derecho legal y unilateral de absorber, adoptar o integrar oficialmente al juego base cualquier idea, lógica o código de los mods y forks creados por la comunidad, mencionando, dando credito y tal vez integrando en el equipo de desarollo al autor original.
