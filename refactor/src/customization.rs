...
impl BuildingAppearance {
    ...
    pub fn default_for(building_type: BuildingType) -> Self {
        match building_type {
            ...
            BuildingType::School => BuildingAppearance {
                style: ArchitecturalStyle::Classical,
                colors: FacadeColor::BEIGE,
                height_floors: 3,
                width_factor: 2.5,
                has_front_garden: true,
            ...
            BuildingType::Police => BuildingAppearance {
                style: ArchitecturalStyle::Brutalist,
                colors: FacadeColor::CONCRETE,
                height_floors: 3,
                width_factor: 1.8,
                has_front_garden: false,
